...
class _ExampleThreeScreenState extends State<ExampleThreeScreen> with TickerProviderStateMixin {
                      ...
                      children: [
                        ...
                        Transform(
                          ...
                          child: Container(
                            ...
                            width: widthAndHeight,
                            height: widthAndHeight,
                            child: Text("Check", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20),),
                          ),
                        ),
                        // right side
                        Transform(
                        ...
                        //front
                        if(_yController.value>=0 && _yController.value <= pi/2 )Container(
                          color: Colors.green,
                          width: widthAndHeight,
                          height: widthAndHeight,
                        ),
